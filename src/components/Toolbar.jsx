...
export default function Toolbar({ onInsert, onInsertRaw, onUndo, onRedo, onCopy, onPaste }) {
    ...
    const handleInsertLink = (markdown) => {
        if (onInsertRaw) {
            onInsertRaw(markdown);
        } else {
            onInsert({ prefix: markdown, suffix: '', placeholder: '' });
        }
    };
