...
const SymbolPicker = ({ onSelect }) => {
    ...
    const categories = {
        Math: [
            { s: '±', n: 'Plus-Minus', d: 'Plus or minus sign' },
            { s: '×', n: 'Multiply', d: 'Multiplication sign' },
            { s: '÷', n: 'Divide', d: 'Division sign' },
            { s: '∑', n: 'Sum', d: 'Summation' },
            { s: '∏', n: 'Product', d: 'N-ary product' },
            { s: '√', n: 'Square Root', d: 'Square root' },
            { s: '∞', n: 'Infinity', d: 'Infinity' },
            { s: '≈', n: 'Almost Equal', d: 'Approximately equal to' },
            { s: '≠', n: 'Not Equal', d: 'Not equal to' },
            { s: '≤', n: 'Less-Than or Equal', d: 'Less-than or equal to' },
            { s: '≥', n: 'Greater-Than or Equal', d: 'Greater-than or equal to' },
            { s: '∂', n: 'Partial Diff', d: 'Partial differential' },
            { s: '∆', n: 'Delta', d: 'Increment' },
            { s: 'π', n: 'Pi', d: 'Greek small letter pi' }
        ],
        Arrows: [
            { s: '←', n: 'Left Arrow', d: 'Leftwards arrow' },
            { s: '↑', n: 'Up Arrow', d: 'Upwards arrow' },
            { s: '→', n: 'Right Arrow', d: 'Rightwards arrow' },
            { s: '↓', n: 'Down Arrow', d: 'Downwards arrow' },
            { s: '↔', n: 'Left Right Arrow', d: 'Left right arrow' },
            { s: '↕', n: 'Up Down Arrow', d: 'Up down arrow' },
            { s: '⇐', n: 'Left Double Arrow', d: 'Leftwards double arrow' },
            { s: '⇑', n: 'Up Double Arrow', d: 'Upwards double arrow' },
            { s: '⇒', n: 'Right Double Arrow', d: 'Rightwards double arrow' },
            { s: '⇓', n: 'Down Double Arrow', d: 'Downwards double arrow' },
            { s: '⇔', n: 'Left Right Double', d: 'Left right double arrow' }
        ],
        Currency: [
            { s: '$', n: 'Dollar', d: 'Dollar sign' },
            { s: '€', n: 'Euro', d: 'Euro sign' },
            { s: '£', n: 'Pound', d: 'Pound sign' },
            { s: '¥', n: 'Yen', d: 'Yen sign' },
            { s: '¢', n: 'Cent', d: 'Cent sign' },
            { s: '₹', n: 'Rupee', d: 'Indian rupee sign' },
            { s: '₿', n: 'Bitcoin', d: 'Bitcoin sign' }
        ],
        Legal: [
            { s: '©', n: 'Copyright', d: 'Copyright sign' },
            { s: '®', n: 'Registered', d: 'Registered sign' },
            { s: '™', n: 'Trademark', d: 'Trademark sign' },
            { s: '§', n: 'Section', d: 'Section sign' },
            { s: '¶', n: 'Paragraph', d: 'Pilcrow sign' }
        ],
        Greek: [
            { s: 'α', n: 'alpha', d: 'Greek small letter alpha' },
            { s: 'β', n: 'beta', d: 'Greek small letter beta' },
            { s: 'γ', n: 'gamma', d: 'Greek small letter gamma' },
            { s: 'δ', n: 'delta', d: 'Greek small letter delta' },
            { s: 'ε', n: 'epsilon', d: 'Greek small letter epsilon' },
            { s: 'λ', n: 'lambda', d: 'Greek small letter lambda' },
            { s: 'π', n: 'pi', d: 'Greek small letter pi' },
            { s: 'θ', n: 'theta', d: 'Greek small letter theta' },
            { s: 'ω', n: 'omega', d: 'Greek small letter omega' },
            { s: 'Ω', n: 'Omega', d: 'Greek capital letter omega' },
            { s: 'µ', n: 'mu', d: 'Micro sign' }
        ],
        Misc: [
            { s: '•', n: 'Bullet', d: 'Bullet' },
            { s: '…', n: 'Ellipsis', d: 'Horizontal ellipsis' },
            { s: '†', n: 'Dagger', d: 'Dagger' },
            { s: '‡', n: 'Double Dagger', d: 'Double dagger' },
            { s: '◊', n: 'Lozenge', d: 'Lozenge' },
            { s: '♠', n: 'Spade', d: 'Black spade suit' },
            { s: '♣', n: 'Club', d: 'Black club suit' },
            { s: '♥', n: 'Heart', d: 'Black heart suit' },
            { s: '♦', n: 'Diamond', d: 'Black diamond suit' }
        ]
    };
